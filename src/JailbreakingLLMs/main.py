...
if __name__ == '__main__':
    ...
    with mp.Pool(processes=16, maxtasksperchild=1) as pool:
        for dataset in datasets:
            ...
            countermeasures=['ppl-5-3.5', 'proactive', 'llm-based', 'sandwich', 'random_seq', 'delimiters', 'xml', 'paraphrasing', 'retokenization']#, 'ppl-5-3.5', 'proactive', 'llm-based','sandwich', 'random_seq', 'delimiters', 'xml', 'paraphrasing', 'retokenization'
            defense_types=['generate_jailbreaks', 'substitute', 'nothing']#, #, 'generate_jailbreaks']#'substitute', 'generate_jailbreaks']
            if args.dataset=="wikibios":
